...
public class Canon001 extends Actor {

  public static final Mesh MESH = MeshLoader.loadMesh("Canon-Mk2.obj");
  public static final Vector2D OFFSET = new Vector2D(0, 0.26142);
  
  private final Rotation aimRotation;
  private final Rotation shipRotation;
  
  public Canon001(Vector2D position, Rotation aimRotation, Rotation shipRotation) {
